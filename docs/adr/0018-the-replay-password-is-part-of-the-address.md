...
> 2026-09-16（#202）：這個決定唯一的風險是「單場 JSON 其實不帶 `password`」。
> 在 2558 列真實資料上跑過，那種列是 **0** —— 見
> [spike 筆記](../specs/2026-09-11-private-replay-sync-spike.md)〈追加：`private: 2`
> 確實存在〉。同時量到 `private: 2` 佔私人場次五分之一，那些場次的連結補不回來，
> 而那是正確結果。
