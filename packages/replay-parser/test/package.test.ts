...
import skillSwap from './fixtures/gen9championsvgc2026regma-2592519449.json'
...
import recoil from './fixtures/gen9championsvgc2026regmb-2674448634.json'
...
import multiHit from './fixtures/gen9vgc2024regf-2082942604.json'
 ...
 */
const FIXTURES = {
  'gen9championsvgc2026regma-2592519449.json': skillSwap,
  ...
  'gen9championsvgc2026regmb-2674448634.json': recoil,
  ...
  // Three hits of Surging Strikes on one target in one turn, and the
  // `|-hitcount|` that closes them (#170).
  'gen9vgc2024regf-2082942604.json': multiHit,
}
