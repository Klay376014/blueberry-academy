...
const SAMPLES: Record<TimelineEvent['kind'], TimelineEvent> = {
  ...
  boost: { kind: 'boost', pokemon: scrafty, stat: 'atk', stages: 2, from: null },
  clearAllBoosts: { kind: 'clearAllBoosts' },
  clearBoosts: { kind: 'clearBoosts', pokemon: scrafty, only: null, from: null },
  setBoost: { kind: 'setBoost', pokemon: scrafty, stat: 'atk', stages: 6, from: null },
  invertBoosts: { kind: 'invertBoosts', pokemon: scrafty, from: null },
  swapBoosts: {
    kind: 'swapBoosts',
    pokemon: scrafty,
    target: whimsicott,
  ...
  copyBoosts: { kind: 'copyBoosts', pokemon: scrafty, target: whimsicott, from: null },
...
const VARIANTS: TimelineEvent[] = [
  ...
  { kind: 'boost', pokemon: scrafty, stat: 'atk', stages: -1, from: null },
  { kind: 'clearBoosts', pokemon: scrafty, only: 'positive', from: null },
  { kind: 'swapBoosts', pokemon: scrafty, target: whimsicott, stats: [], from: null },
